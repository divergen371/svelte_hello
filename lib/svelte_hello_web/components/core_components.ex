defmodule SvelteHelloWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SvelteHelloWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SvelteHelloWeb.Gettext, "errors", msg, opts)
    end
  end
